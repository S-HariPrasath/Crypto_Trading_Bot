...
from send_trading_report_in_mail import EmailWrapper
...
class PlaceOrders:
    ...
    def buy_order(self):
        ...
        self.email_wrapper.send_email(buy_msg, buy_subject)
        return buy_order
    ...
    def sell_order(self):
        ...
        self.email_wrapper.send_email(sell_msg, sell_subject)
